...
@pytest.fixture
def api_key():
    #this code mocks the environment variable for the API key 
    # and yields it as an Airflow variable
    #yieldmeans that the value will be provided to the test function 
